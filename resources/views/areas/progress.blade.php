        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-6">
                        <h2 class="text-3xl font-semibold mb-2">{{ $area->name }} - Progress</h2>
                        <p class="text-gray-600">Track your learning progress in this area</p>
                    </div>
                    ...
                    @else
                        <div class="text-center py-8">
                            <p class="text-gray-600">No learning paths available for this area yet.</p>
                        </div>
                    @endif
                </div>
            </div>
