<x-app-layout>
    ...
    <script>
        ...
        const dropzone = new Dropzone("#mediaUploadForm", {
            ...
            dictDefaultMessage: "{{ __('media.dropzone.message') }}",
            dictInvalidFileType: "{{ __('media.dropzone.invalid_type') }}",
            dictFileTooBig: "{{ __('media.dropzone.file_too_big') }}",
            dictMaxFilesExceeded: "{{ __('media.dropzone.max_files') }}",
            init: function() {
