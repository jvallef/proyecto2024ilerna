            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="sm:flex sm:items-center sm:justify-between mb-6">
                        <div>
                            <h2 class="text-xl font-semibold text-gray-900">Áreas</h2>
                            <p class="mt-1 text-sm text-gray-600">Gestiona las áreas del sistema</p>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex-1 max-w-lg">
                                <x-search-autocomplete 
                                    ...
                                    :search-url="route('api.areas.search')"
                    ...
                    @if($featuredAreas->count() > 0)
                        <div class="mb-8">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">Áreas Destacadas</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex justify-end space-x-2">
                                                ...
                                                <div x-data>
                                                    <button type="button" 
                                                            @click="$dispatch('open-modal', 'confirm-area-deletion-{{ $area->id }}')"
                                                ...
                                                <x-modal name="confirm-area-deletion-{{ $area->id }}" focusable>
                                                    <form method="post" action="{{ route('admin.areas.destroy', $area) }}" class="p-6">
                                                        @csrf
                                                        @method('DELETE')
