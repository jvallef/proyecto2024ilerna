                ...
                <div class="p-6 text-gray-900">
                    <div class="sm:flex sm:items-center sm:justify-between mb-6">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-600">Gestiona los usuarios del sistema</p>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex-1 max-w-lg">
                                <x-search-autocomplete 
                                    ...
                                    :search-url="route('admin.api.users.search')"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex justify-end space-x-2">
                                                ...
                                                @else
                                                    <div x-data>
                                                        <button type="button" 
                                                                @click="$dispatch('open-modal', { id: 'delete-user-{{ $user->id }}' })"
                                                        ...
                                                        <x-modal-confirm
                                                            ...
                                                            :action="route('admin.users.destroy', ['user' => $user, 'page' => request('page', 1), 'search' => request('search')])"
                                                            confirm="Eliminar"
                                                            cancel="Cancelar"
                                                        />
                                                    </div>
