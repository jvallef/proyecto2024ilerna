            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="sm:flex sm:items-center sm:justify-between mb-6">
                        <div>
                            <h2 class="text-xl font-semibold text-gray-900">{{ __('Cursos Eliminados') }}</h2>
                            <p class="mt-1 text-sm text-gray-600">{{ __('Gestiona los cursos eliminados del sistema') }}</p>
                        </div>
                    </div>
                    ...
                    @if($courses->isEmpty())
                        <div class="text-center py-4">
                            <p class="text-gray-500">{{ __('No hay cursos eliminados') }}</p>
                        </div>
                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end space-x-3">
                                                    <form action="{{ route('admin.courses.restore', $course->id) }}" method="POST" class="inline">
                                                        @csrf
                                                        @method('PATCH')
                                                    ...
                                                    <form action="{{ route('admin.courses.force-delete', $course->id) }}" method="POST" class="inline">
                                                        @csrf
                                                        @method('DELETE')
